...
cook.bounds.geojson <- readLines("data/cook-boundaries.geojson") %>% paste(collapse = "\n") 
...
## ----mapbox----------------------------------------------------------------------------------------------------------------
# MAPBOX_TOKEN <- readLines('utils/mapbox-api.txt')
